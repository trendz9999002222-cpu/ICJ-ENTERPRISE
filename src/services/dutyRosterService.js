      ...
      return raw ? JSON.parse(raw) : [
        {
          id: "DUTY-REQ-001",
          timestamp: new Date().toISOString(),
          userId: "26ICJ08AA0002",
          userName: "Senior Advocate PAWAN GUPTA",
          userPhone: "+91 9999002222",
          role: "advocate",
          territoryRegion: "Delhi & NCR / Allahabad",
          territoryState: "Delhi / UP",
          territoryDistrict: "New Delhi / Prayagraj",
          notes: "Available for Supreme Court & High Court Duty Roster Shift",
          status: "APPROVED",
        },
        {
          id: "DUTY-REQ-002",
          timestamp: new Date(Date.now() - 7200000).toISOString(),
          userId: "26ICJ08AA0006",
          userName: "Advocate Ananya Sharma",
          userPhone: "+91 9811223344",
          role: "advocate",
          territoryRegion: "National Capital Region",
          territoryState: "Delhi",
          territoryDistrict: "South Delhi",
          notes: "Available for Commercial & NCLT Duty Roster",
          status: "PENDING",
        },
      ];
    } catch {
    ...
    return [
      {
        ...
        role: "Lead Duty Advocate",
        region: "Delhi & NCR / Allahabad",
        phone: "+91 9999002222",
      ...
      {
        id: "ICJ-2026-DUTY-ADV-02",
        userId: "26ICJ08AA0006",
        name: "Advocate Ananya Sharma",
        role: "Duty Commercial Counsel",
        region: "Delhi & NCR",
        phone: "+91 9811223344",
