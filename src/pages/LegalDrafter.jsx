...
export default function LegalDrafter() {
  ...
  // Phase D — Version Control & Draft History
  const [draftHistory, setDraftHistory] = useState([
    { id: "v2.0", title: "Writ Petition - Final Approved Draft", docType: "Writ Petition", version: "v2.0", date: "2026-08-06", status: "Approved", hash: "SHA256-DRAFT-98124" },
    { id: "v1.1", title: "Writ Petition - Client Review Draft", docType: "Writ Petition", version: "v1.1", date: "2026-08-05", status: "In Review", hash: "SHA256-DRAFT-98123" },
  ]);

  useEffect(() => {
    const list = LegalEcosystemService.getCases();
    setCases(list);
    if (list.length > 0) {
...
================================================================================`;
  ...
  const stats = useMemo(() => {
    return {
      draftsCreated: draftHistory.length + 14,
      pendingDrafts: 3,
