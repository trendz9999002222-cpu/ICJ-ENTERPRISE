...
const DICTIONARIES = {
  en: {
    ...
    translations: {
      ...
      jurisdictionLabel: "🌐 Global Legal Jurisdiction:",
      
      // Admin Panel Keys (100% Pure English)
      adminTitle: "Super Admin Command Centre",
      adminSubtitle: "Unified Enterprise Governance, Member Registrations, Financial Ledger & System Health",
      adminKpiCases: "Total Legal Matters",
      adminKpiMembers: "Registered Members",
      adminKpiAdvocates: "Empaneled Advocates",
      adminKpiRevenue: "Escrow Ledger Balance",
      adminSystemHealth: "System Telemetry & Health",
      adminRecentActivities: "Recent System Audit Logs",
      adminUserManagement: "Member & Access Management",
      adminLicensing: "Statutory License Engine",
      adminSecurityCompliance: "Security & BSA Compliance",
      adminDatabaseConfig: "Database & Storage Setup",
      adminApiConfig: "API & Gateway Settings",
      adminDeploymentCenter: "Cloud Deployment Center",

      // Advocate Desk Keys
      advocateTitle: "Enterprise Professional Command Centre",
      advocateSubtitle: "Legal Counsel Management, Client Appointments, Communication Queues & Case Calendar",
      advocateKpiActive: "Active Cases",
      advocateKpiToday: "Today's Hearings",
      advocateKpiTasks: "Pending Tasks",
      advocateKpiClients: "Client Directory",
      ...
      // Pure Categories (Zero Parentheses / Dual-Mix)
  ...
  hi: {
    ...
    translations: {
      ...
      englishFallback: "ENGLISH",
      jurisdictionLabel: "🌐 वैश्विक क्षेत्राधिकार:",

      // Admin Panel Keys (100% Pure Hindi)
      adminTitle: "मुख्य सुपर एडमिन कमान केंद्र",
      adminSubtitle: "एकीकृत एंटरप्राइज प्रशासन, सदस्य पंजीकरण, वित्तीय बहीखाता व प्रणाली स्वास्थ्य",
      adminKpiCases: "कुल कानूनी मामले",
      adminKpiMembers: "पंजीकृत सदस्य",
      adminKpiAdvocates: "पैनलबद्ध अधिवक्ता",
      adminKpiRevenue: "एस्क्रो खाता शेष",
      adminSystemHealth: "प्रणाली टेलीमेट्री व स्वास्थ्य",
      adminRecentActivities: "हाल के सिस्टम ऑडिट लॉग",
      adminUserManagement: "सदस्य व पहुंच प्रबंधन",
      adminLicensing: "वैधानिक लाइसेंस इंजन",
      adminSecurityCompliance: "सुरक्षा व बीएसए अनुपालन",
      adminDatabaseConfig: "डेटाबेस व स्टोरेज विन्यास",
      adminApiConfig: "एपीआई व गेटवे सेटिंग्स",
      adminDeploymentCenter: "क्लाउड परिनियोजन केंद्र",

      // Advocate Desk Keys
      advocateTitle: "प्रोफेशनल एडवोकेट कमान केंद्र",
      advocateSubtitle: "कानूनी परामर्श प्रबंधन, क्लाइंट अपॉइंटमेंट्स, संचार कतार व केस कैलेंडर",
      advocateKpiActive: "सक्रिय मामले",
      advocateKpiToday: "आज की सुनवाई",
      advocateKpiTasks: "लंबित कार्य",
      advocateKpiClients: "क्लाइंट निर्देशिका",
      ...
      stage1CategoryLabel: "मामले का प्रकार",
      ...
      stage2Subtitle: "सिस्टम आपके कागजातों को कानूनी प्रक्रिया अनुसार अपने आप क्रमबद्ध कर देगा।",
      ...
      aiOngoingCaseBtn: "🚨 पहले से चल रहा कोर्ट केस (रेस्क्यू)",
      aiCategoryLabel: "मामले की श्रेणी",
      aiVoiceLabel: "🎙️ आपकी पूरी समस्या व केस विवरण (वॉयस रिकॉर्डिंग व ट्रांसक्रिप्ट)",
      aiVoicePlaceholder: "यहाँ क्लिक करके 1 से 5 पेज की पूरी समस्या बोलें... आपका बोला गया एक-एक शब्द यहाँ रियल-टाइम में टाइप होगा!",
      aiOutcomeLabel: "आप क्या चाहते हैं? (वांछित परिणाम)",
      aiOutcomePlaceholder: "उदा. अग्रिम जमानत और एफआईआर निरस्तीकरण",
      aiAttachedDocs: "📁 संलग्न कागजात:",
      aiRunDiagnosisBtn: "🤖 AI केस निदान चलाएं",
      aiRunOngoingDiagnosisBtn: "🚨 चलते केस की रणनीति व ट्रांसफर विश्लेषण चलाएं",

      // Pure Hindi Categories
      catCivil: "🏛️ दीवानी विवाद",
  ...
  gu: {
    ...
    translations: {
      ...
      englishFallback: "ENGLISH",
      jurisdictionLabel: "🌐 વૈશ્વિક અધિકારક્ષેત્ર:",

      adminTitle: "સુપર એડમિન કમાન્ડ સેન્ટર",
      adminSubtitle: "એકીકૃત એન્ટરપ્રાઇઝ વહીવટ અને સિસ્ટમ સ્થિતિ",
      adminKpiCases: "કુલ કાનૂની કેસો",
      adminKpiMembers: "નોંધાયેલ સભ્યો",
      adminKpiAdvocates: "પેનલ વકીલો",
      adminKpiRevenue: "એસ્ક્રો ખાતાની બાકી રકમ",

      advocateTitle: "પ્રોફેશનલ વકીલ કમાન્ડ સેન્ટર",
      advocateSubtitle: "કાનૂની સલાહ વ્યવસ્થાપન અને કેસ કેલેન્ડર",
      ...
      aiConsultationTitle: "AI લીગલ કન્સલ્ટેશન એન્જિન — 'તમે શું ઇચ્છો છો?'",
      aiConsultationSubtitle: "અપલોડ કરેલ ફાઇલો અને અવાજ રેકોર્ડિંગના આધારે ત્વરિત કાનૂની વિશ્લેષણ.",
      aiSection1Title: "📝 1. નવી સમસ્યા અથવા ચાલી રહેલો કેસ નોંધો",
      aiNewCaseBtn: "🆕 નવો કેસ શરૂ કરવો છે",
      aiOngoingCaseBtn: "🚨 ચાલી રહેલો કોર્ટ કેસ",
      aiCategoryLabel: "કેસ શ્રેણી",
      aiVoiceLabel: "🎙️ તમારી સંપૂર્ણ સમસ્યા અને કેસ વિગત",
      aiVoicePlaceholder: "અહીં બોલીને 1 થી 5 પેજની સંપૂર્ણ સમસ્યા નોંધો...",
      aiOutcomeLabel: "તમે શું ઇચ્છો છો?",
      aiOutcomePlaceholder: "દા.ત. અગાઉથી જામીન અને એફઆઈઆર રદ કરવી",
