...
export const SPECIAL_TRIBUNALS_DIRECTORY = [
  {
    ...
    caseTypes: [
      { id: "NCLT_IBC_7", code: "CP(IB)-Sec 7", name: "Section 7 IBC Financial Creditor Insolvency Petition (CIRP)", category: "Financial Debt Insolvency", subCategories: ["Bank / Financial Institution Loan Default (> 1 Crore)", "Homebuyer Class Financial Creditor Petition", "Debenture Holder Default Recovery"] },
      { id: "NCLT_IBC_9", code: "CP(IB)-Sec 9", name: "Section 9 IBC Operational Creditor Insolvency Petition (CIRP)", category: "Operational Debt Insolvency", subCategories: ["Unpaid Vendor / Supplier Invoices (> 1 Crore)", "Unpaid Employee / Workman Salary Arrears", "Contractor Service Default Claim"] },
      { id: "NCLT_IBC_10", code: "CP(IB)-Sec 10", name: "Section 10 IBC Corporate Applicant Voluntary Insolvency", category: "Voluntary Bankruptcy", subCategories: ["Company Voluntary CIRP Initiation", "Corporate Debtor Resolution Initiation"] },
      { id: "NCLT_IBC_60", code: "IA-Sec 60(5)", name: "Section 60(5) IBC Interlocutory & Stay Application", category: "CIRP Applications", subCategories: ["Interim Stay on Asset Sale / Auction", "Application for Replacement / Removal of IRP/RP", "Objection to Committee of Creditors (CoC) Resolution Plan", "Exclusion of Lockdown / Moratorium Period Calculation"] },
      { id: "NCLT_OPP_MIS", code: "CP-Sec 241/242", name: "Section 241-242 Oppression & Mismanagement Petition", category: "Shareholder Dispute", subCategories: ["Oppression of Minority Shareholder Rights", "Siphoning of Company Funds & Asset Diversion", "Winding Up on Just & Equitable Grounds"] },
      { id: "NCLT_SCHEME", code: "CA-Sec 230-232", name: "Section 230-232 Scheme of Merger, Amalgamation & Demerger", category: "Corporate Restructuring", subCategories: ["Merger & Amalgamation Scheme Approval", "Demerger & Spin-Off Scheme Sanction", "Compromise and Arrangement with Creditors/Members"] },
      { id: "NCLT_CAPITAL", code: "CP-Sec 59/66", name: "Section 59/66 Rectification of Register & Capital Reduction", category: "Capital Governance", subCategories: ["Reduction of Share Capital Approval (Sec 66)", "Rectification of Register of Members (Sec 59)"] },
      { id: "NCLAT_APPEAL", code: "NCLAT-Sec 61", name: "Section 61 IBC Statutory Appeal before NCLAT", category: "Appellate NCLAT", subCategories: ["Appeal against Section 7/9 CIRP Admission Order", "Appeal against Section 31 Resolution Plan Approval", "Appeal against Section 33 Liquidation Order"] },
    ],
  },
  {
    id: "DRT",
  ...
  },
  {
    ...
    caseTypes: [
      { id: "RERA_COMPLAINT_31", code: "SEC 31 CMP", name: "Section 31 Complaint (Delayed Possession / Refund / Interest)", category: "Buyer Relief & Refund", subCategories: ["Delayed Possession Interest Claim (MCLR + 2%)", "Refund of Total Principal with Interest", "Rectification of Construction Structural Defects (Sec 14(3))", "Delayed Handover of Common Amenities & Club House"] },
      { id: "RERA_AO_COMPLAINT_71", code: "SEC 71/72 AO", name: "Section 71/72 Compensation Claim (Adjudicating Officer)", category: "Adjudicating Officer Claim", subCategories: ["Compensation for Mental Agony & Trauma", "Compensation for Loss Due to Misleading Advertisement (Sec 12)", "Damage Assessment for Delay in Project Completion"] },
      { id: "RERA_RECOVERY_40", code: "SEC 40 RC", name: "Section 40 Recovery Certificate Enforcement (DM Recovery)", category: "Revenue Recovery (RC)", subCategories: ["Issuance of Recovery Certificate to District Magistrate", "Attachment of Builder Bank Accounts & Land for Auction", "Execution of Final RERA Refund Order"] },
      { id: "RERA_APPEAL_43", code: "SEC 43/44 REAT", name: "Section 43/44 Statutory Appeal (REAT Appellate Tribunal)", category: "Real Estate Appellate (REAT)", subCategories: ["Allottee Appeal against Authority Order", "Promoter / Builder Appeal (70% Mandatory Pre-Deposit)", "Appeal on Dispute of Penalty or Interest Rate"] },
      { id: "RERA_INTERIM_36", code: "SEC 36 STAY", name: "Section 36 Interim Restraint / Injunction Order", category: "Interim Injunction", subCategories: ["Restraint on Builder from Creating Third-Party Rights", "Stay on Bank Guarantee Encashment / Cancellation of Unit", "Interim Direction for Restoration of Basic Utilities"] },
      { id: "RERA_PENALTY_59", code: "SEC 59/63 PENALTY", name: "Section 59/63 Penalty for Unregistered Sale / Non-Compliance", category: "Regulatory Penal Action", subCategories: ["Prosecution for Selling Units without RERA Registration", "Contempt Penalty for Non-Compliance of Authority Directions"] },
    ],
  },
  {
    id: "AFT",
