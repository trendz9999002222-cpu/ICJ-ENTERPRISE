...
export const MASTER_MODULE_GROUPS = [
  ...
  },
  {
    ...
    modules: [
      ...
      { code: "G9", keyword: "WESTLAW_HYPERGRAPH_VIEWER", name: "वेस्टलॉ-ग्रेड सेमेंटिक विधिक हाइपरग्राफ", file: "SemanticHyperlinkedBareActViewer.jsx", route: "/client-portal#westlaw-hypergraph" },
